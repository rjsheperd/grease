//
//  Bridge.h
//  grease — shared C bridge (canonical location)
//
//  This file is the canonical source for Bridge.h.
//  The copy at xcode/MobileTest/csource/Bridge.h is kept for Xcode IDE
//  navigation; both must remain in sync.
//
